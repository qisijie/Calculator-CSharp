...
namespace Calculator
{
    public partial class MainForm : Form
    {
        ...
        decimal number1 = 0m, number2 = 0m, result, pi = 3.14m, v1n = 0m, v2n = 0m, v3n = 0m, ren = 0m;
        ...
        enum Selected { none, square, triangle, parallelogram, trapezium, circle, semicircle, ring, rectangle, cube, cuboid }
        /*
         * 面积计算模式
        ...
        private void gotit_Click(object sender, EventArgs e)
        {
            switch (select)
            {
                ...
                case Selected.semicircle:
                    ren = pi * Convert.ToDecimal(Math.Pow(Convert.ToDouble(v1n), 2)) / 2m;
                    re.Text = Convert.ToString(ren);
                    break;
                case Selected.ring:
                ...
                case Selected.rectangle:
                    ...
                    break;
                case Selected.cube:
                    ren = Convert.ToDecimal(Math.Pow(Convert.ToDouble(v1n), 3));
                    re.Text = Convert.ToString(ren);
                    break;
